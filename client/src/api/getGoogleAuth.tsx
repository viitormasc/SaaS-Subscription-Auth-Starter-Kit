...
export default async function getGoogleAuth() {
  try {
    ...
    window.location.href = 'http://localhost:2121/api/auth/google'; // Or just '/api/auth/google' if your frontend and backend are on the same domain/port for initial load
